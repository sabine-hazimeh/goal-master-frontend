        ...
        <div className="about-lower">
          <div className="lower-left">
            <p className="lower-text">
              Our mission is to provide you with the tools, insights, and
              support you need to turn your ambitions into reality. Through our
              innovative platform, we offer personalized goal-setting, daily
              scheduling, and progress tracking, all designed to help you stay
