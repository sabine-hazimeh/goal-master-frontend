      ...
      <div className="goals-form">
        <div className="goals-form-left">
          <form>
            ...
            <br />
            <label>
              <input type="checkbox" name="health" checked={category.health} onChange={handleChange} />
              Health
            </label>
            <br />
            <label>
              <input type="checkbox" name="education" checked={category.education} onChange={handleChange} />
              Education
            </label>
          </form>
